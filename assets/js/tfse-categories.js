(function () {
    ...
    function renderDetail() {
        ...
        detail.innerHTML = [
            ...
            "<div class=\"section section-padding-t110-b120 newsletter-section\" data-bg-color=\"#000\" data-overlay=\"0.7\" data-bg-image=\"assets/images/tfse/tfse-database-hero.png\"><div class=\"container\"><div class=\"cta-content text-center\"><div class=\"section-title color-light text-center mb-0\"><h2 class=\"title\">不確定適合哪類？先做免費財務健檢查詢</h2><p class=\"sub-title fz-18\">只收低敏需求資料，協助導向資料庫、文章與法令資訊，不代辦、不收證件、不保證核貸。</p></div><a href=\"free-check.html\" class=\"btn btn-primary btn-hover-secondary mt-6\">免費財務健檢查詢</a></div></div></div>"
        ].join("");
    }
