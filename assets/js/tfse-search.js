(function () {
    ...
    function renderResults() {
        ...
        Promise.all([
            ...
            if (!results.length) {
                resultRoot.innerHTML = "<div class=\"col\"><p>找不到符合條件的資訊，可改用「房貸」「信貸」「債務」「防詐」等關鍵字，或先填寫免費財務健檢。</p><a class=\"btn btn-primary btn-hover-secondary mt-4\" href=\"free-check.html\">免費健檢</a></div>";
                return;
            }
