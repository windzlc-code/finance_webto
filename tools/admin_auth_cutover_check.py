...
READY_STATUS = "ready_for_formal_auth_validation"
RELATED_EXPORTS = ["tfse_backend_acceptance_matrix", "tfse_admin_security_matrix"]


def build_report():
    return admin_cutover_tooling.auth_cutover_report()


def markdown(report):
    lines = [
        "# TFSE Admin Auth Cutover Check",
        "",
