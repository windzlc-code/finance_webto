...
def build_report():
    ...
    return {
        ...
        "server_commands": [
            ...
            "curl -I --max-time 10 https://tfse.tfse-fcc.com/",
            "curl -I --max-time 10 https://tfse.tfse-fcc.com/bank-club/index.html",
            "curl -I --max-time 10 https://tfse.tfse-fcc.com/admin.html",
            "curl -sS --max-time 10 https://tfse.tfse-fcc.com/api/health",
            "curl -I -X OPTIONS --max-time 10 https://tfse.tfse-fcc.com/api/bank-club/leads",
            "curl -i --max-time 10 https://tfse.tfse-fcc.com/api/admin/bank-club/leads",
        ],
