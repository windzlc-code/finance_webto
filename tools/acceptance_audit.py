...
def build_items():
    ...
    checks = [
        ...
        ("業務閉環", "article_to_free_check", "文章頁能進入免費財務健檢查詢", exists("blog-details.html") and contains("blog-details.html", "data-article-detail", "free-check.html"), "文章詳情頁已保留免費財務健檢查詢 CTA", "文章到免費財務健檢查詢 CTA 缺失"),
        ...
        ("UI 驗收", "form_feedback", "表單錯誤提示清楚", contains("assets/js/tfse-lead-form.js", "setMessage", "form.reportValidity"), "免費財務健檢查詢表單有 validity 與訊息回饋", "表單提示缺失"),
        ...
        ("合規驗收", "privacy_line_consent", "隱私與 Line 同意獨立", contains("free-check.html", "consent_privacy", "consent_line"), "免費財務健檢查詢表單隱私同意與 Line 同意分離", "隱私或 Line 同意欄位缺失"),
        ...
        ("技術驗收", "key_pages", "關鍵頁面存在", all(exists(path) for path in ("index.html", "database.html", "free-check.html", "admin.html", "404.html")), "首頁、資料庫、免費財務健檢查詢、Admin、404 均存在", "關鍵頁面缺失"),
        ("技術驗收", "not_found", "404 正常", exists("404.html") and contains("404.html", "資料庫", "免費財務健檢查詢"), "404.html 已建立並可導回資料庫/免費財務健檢查詢", "404 頁缺失或回流入口缺失"),
