...
此清單用來補齊《銀行俱樂部獨立站完整實施計劃.docx》中無法單靠程式碼完成的正式上線項目。程式碼已提供前台、表單、後台 CRM、文章/文件管理、追蹤、備份、2FA、通知 Webhook 與上線檢查；正式閉環需要把下列外部設定逐項落地並留下驗收證據。
