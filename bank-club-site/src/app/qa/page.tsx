...
export const metadata = createPageMetadata({
  title: "貸款常見 QA｜網路申貸、文件、資金用途與核貸提醒｜銀行行員俱樂部",
...
const qa: TrackedFaqItem[] = [
  ...
  { id: "credit-income-documents", question: "信貸財力證明需要哪些資料？", answer: "上班族常見薪轉、扣繳憑單、勞保資料；自營業主常見營業資料、流水與報稅資料。", href: "/consultation?source_page=qa_income_documents" },
  ...
  { id: "self-employed-no-payroll", question: "自營業主沒有薪資單怎麼辦？", answer: "沒有固定薪資單時，可先整理營業登記、銀行流水、報稅資料、合約或其他可佐證收入的資料，再由專員確認是否足夠。", href: "/consultation?source_page=qa_self_employed_documents" },
